...
const attractionsCategories = [
  {
    ...
    items: [
      {
        id: 1,
        image: "/attractions/splash/splash-1.png",
        logo: "/attractions/splash/logo-1.png",
        description: "Wahoo Waterworld",
        bgColor: "#1e6bc7",
      ...
      {
        id: 2,
        image: "/attractions/splash/splash-2.png",
        logo: "/attractions/splash/logo-2.png",
        description: "Bumi Pancasona",
        bgColor: "#7e3fa3",
      ...
      {
        id: 3,
        image: "/attractions/splash/splash-3.png",
        logo: "/attractions/splash/logo-3.png",
        description: "Mason Pine Hotel",
        bgColor: "#cb6140",
        schedule: "07.00 - 21.00",
        link: "#",
      },
  ...
  },
  {
    ...
    items: [
      {
        id: 1,
        image: "/attractions/art/art-1.png",
        logo: "/attractions/art/logo-1.png",
        description: "Puspa Intek Sundial",
        bgColor: "#8b0000",
      ...
      {
        id: 2,
        image: "/attractions/art/art-2.png",
        logo: "/attractions/art/logo-2.png",
        description: "Bale Seni Barli",
        bgColor: "#8cb04a",
  ...
  },
  {
    ...
    items: [
      {
        id: 1,
        image: "/attractions/fun/fun-1.png",
        logo: "/attractions/fun/logo-1.png",
        description: "Parahyangan Golf",
        bgColor: "#375512",
      ...
      {
        id: 2,
        image: "/attractions/fun/fun-2.png",
                        ...
                        >
                          ...
                          <div className="relative h-3/5 w-full">
                            <Image
                              ...
                              alt={attractionsCategories[selectedAttraction].title}
                              fill
                              className="object-cover"
                            />
                              ...
                              <AnimatePresence mode="wait">
                                {hoveredCard === itemIndex ? (
                                  ...
                                  <motion.p
                                    ...
                                    className="text-white text-md sm:text-xl font-semibold text-shadow-md"
                                  >
                                    {attractionsCategories[selectedAttraction].title}
                                  </motion.p>
                                )}
                              </AnimatePresence>
                            </div>
                            ...
                            <div className="flex items-center justify-center w-1/3 sm:w-2/3">
                              <div className="w-full sm:w-40 ml-2 sm:ml-0 h-full relative">
                                <Image
                                  ...
                                  alt={`${attractionsCategories[selectedAttraction].title} logo`}
                                  fill
