...
const vacayData = [
  {
    ...
    readTime: "1 min read",
    image: "/kbpa-vacay-mode/image-1.png",
    comments: 0,
    likes: 1,
    href: "#",
  },
  {
    id: 2,
    title: "Kota Baru Parahyangan Persembahkan Temoat Bermain Baru: Bumi Skate...",
    kota: "Kota Baru Parahyangan",
    readTime: "3 min read",
    image: "/kbpa-vacay-mode/image-2.png",
    comments: 0,
    likes: 0,
    href: "#",
  },
  {
    ...
    kota: "Kota Baru Parahyangan",
    readTime: "1 min read",
    image: "/kbpa-vacay-mode/image-3.png",
    comments: 0,
    likes: 3,
    href: "#",
  },
      ...
      <div className="container mx-auto">
        ...
        <div className="text-center py-20">
            <div className="overflow-hidden">
                <motion.h1
                    className="text-3xl sm:text-6xl font-semibold block"
                ...
                >
                    <span className="text-[#8cb04a]">KBPa</span> <span className="text-[#000000]">Vacay Mode</span>
                </motion.h1>
            </div>
        </div>
        ...
        <div className="pb-9 max-w-[950px] mx-auto pb-6">
          <div className="grid grid-cols-1 px-4 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {vacayData.map((vacay) => (
              <VacayCard key={vacay.id} vacay={vacay} />
            ))}
          </div>
        </div>
...
function VacayCard({ vacay }) {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${vacay.image})`,
    ...
    >
      <div className="absolute inset-0 py-8 px-6 flex flex-col justify-between" style={{ backgroundColor: "rgba(0, 0, 0, 0.6)" }} onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
        ...
        <div className="text-white">
          <div className="text-xs font-semibold">{vacay.kota}</div>
          <div className="text-xs font-semibold">{vacay.readTime}</div>
        </div>
        ...
        <div className="mt-auto">
          ...
          >
            <h2
              className={`text-xl sm:text-[15px] leading-snug font-bold transition-colors ${
          ...
          <div className="flex justify-between items-center mt-4">
            ...
            >
              ...
              <span className="text-white text-sm">{vacay.comments}</span>
            </div>
            <Link href="#" className="flex items-center space-x-2 group">
              {/* Like */}
              <span className="text-white text-sm">{vacay.likes}</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
                height="18"
