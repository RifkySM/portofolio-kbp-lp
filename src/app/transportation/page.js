    ...
    <main className="min-h-screen bg-white pb-[10vh]">
      ...
      <div className="mx-auto max-w-4xl px-6 mb-32 relative">
        <div className="h-[330px] bg-gray-100 rounded-lg shadow-md overflow-hidden relative">
          {/* Halte List */}
          <div className="absolute left-0 top-0 bottom-0 w-44 h-[300px] ml-[10px] mt-[10px] rounded-l-[20px] bg-white z-10 overflow-y-auto shadow-md">
            <div className="pt-2 pb-4 px-4 ">
              {halteData.map((halte) => (
                ...
                >
                  <div className="bg-purple-600 rounded-full p-1 mr-2 -ml-4 flex items-center justify-center">
                    <svg
                  ...
                  <span className="text-sm font-medium text-black truncate w-full" title={halte.name}>{halte.name}</span>
                </div>
              ))}
            </div>
          </div>
