    ...
    return(
        <footer className="h-auto bg-[rgb(24,80,126)] text-white py-2 px-4 md:px-12">
            <div className="container mx-auto">
                ...
                {/* Left side - Main logo */}
                <div className="mb-6 md:mb-0 pl-11">
                    <Link href="/">
                ...
                <div className="grid grid-cols-3 gap-1 mb-6 md:mb-0">
                    {/* First row of logos */}
                    ...
                    <Link href="/parahyangan-golf">
                        <div className="relative w-44 h-20 pl-4">
                ...
                <div className="text-xs font-bold pt-10 pr-48">
                    ...
                    <div className="border-t border-gray-300 mb-3 w-2/5"></div>
