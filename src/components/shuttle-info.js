    ...
    <div className="mx-auto max-w-7xl px-4 mb-20">
      ...
      <div className="flex flex-col lg:flex-row ml-0 md:ml-0 lg:ml-[100px]">
        ...
        <div className="w-full lg:w-2/5 relative flex justify-center lg:block">
          ...
          >
            <h3 className="text-xl md:text-3xl font-bold mb-1 md:mb-2 text-center px-4">St. KCIC Padalarang</h3>
            <div className="flex items-center justify-center">
              <span style={{ transform: 'rotate(90deg)' }} className="text-2xl md:text-4xl">⇄</span>
            </div>
            <h3 className="text-xl md:text-3xl font-bold mt-1 md:mt-2 text-center px-4">KBPa (Bumi Hejo)</h3>
          </div>
        </div>
